 ...
 * 프로젝트 색상 중앙 관리
 *
 * - 표준 Tailwind 색상(violet, slate, gray 등)은 Tailwind v4 기본 팔레트에 포함되어 있어
 *   클래스로 바로 사용할 수 있습니다.
 * - 커스텀 색상(mauve, olive, mist, taupe)은 globals.css 의 @theme 에 등록되어 있습니다.
 * - JS 에서 색상 hex/oklch 값을 직접 참조할 때 이 파일을 사용합니다.
 *
 * @example JS에서 직접 참조
